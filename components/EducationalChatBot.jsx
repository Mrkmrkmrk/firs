...
const INITIAL_MESSAGES = [
  {
    id: "welcome-message",
    content: "👋 Hi there! I'm your educational assistant. Ask me about any educational concept, career advice, or learning tips!",
    role: "bot",
    timestamp: new Date(),
  },
];
          ...
          <div className="flex flex-col h-[calc(100vh-2rem)]">
            <SheetHeader className="border-b p-4">
              <div className="flex justify-between items-center">
                <SheetTitle>Educational Assistant</SheetTitle>
